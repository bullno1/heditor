...
#ifdef PICO_LOG_SHARED
#	if defined(_WIN32) && !defined(__MINGW32__)
#		ifdef PICO_LOG_IMPLEMENTATION
#			define PICO_LOG_API __declspec(dllexport)
#		else
#			define PICO_LOG_API __declspec(dllimport)
#		endif
#	else
#		ifdef PICO_LOG_IMPLEMENTATION
#			define PICO_LOG_API __attribute__((visibility("default")))
#		else
#			define PICO_LOG_API extern
#		endif
#	endif
#else
#	define PICO_LOG_API extern
